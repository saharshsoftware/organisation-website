...
import { NAV_LINK, SOCIAL_LINKS } from "../../shared/constants";
...
<template>
  ...
  >
    ...
    >
      ...
      >
        ...
        <div
          class="flex flex-row gap-4 items-center justify-start shrink-0 h-[29px] relative"
        >
        <!-- twitter -->
          <svg
            ...
            width="29"
            viewBox="0 0 512 512"
            @click="openLink(SOCIAL_LINKS.TWITTER)"
          >
            <path
          ...
          <svg
            ...
            width="29"
            viewBox="0 0 448 512"
            @click="openLink(SOCIAL_LINKS.LINKEDIN)"
          >
            <path
          ...
          <svg
            ...
            width="29"
            viewBox="0 0 512 512"
            @click="openLink(SOCIAL_LINKS.FACEBOOK)"
          >
            <path
          ...
          <svg
            ...
            width="29"
            viewBox="0 0 448 512"
            @click="openLink(SOCIAL_LINKS.INSTAGRAM)"
          >
            <path
  ...
  >
    <div
      class="flex flex-row gap-2.5 items-center justify-center self-stretch shrink-0 h-24 relative"
    >
      <div
